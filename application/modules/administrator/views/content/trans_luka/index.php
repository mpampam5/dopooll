  ...
  <div class='box-header with-border'>
    <h3 class='box-title'>Modul <?=ucfirst($layout_title)?></h3>
      <div class='box-tools pull-right'>
        <a href='<?=site_url(config_item("cpanel")."trans_luka/tambah")?>' id='tambah' class='btn btn-success btn-sm'> Tambah</a>
      </div>
  </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": '<?=base_url(config_item("cpanel")."trans_luka/json")?>', "type": "POST"},
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
                        },{"data": "id_rekam_medik"},{"data": "jenis_luka"},{"data": "posisi_luka"},{"data": "foto"},{"data": "created_at"},{"data": "update_at"},{"data": "created_by"},{"data": "update_by"},
                        {
                            "data" : "action",
                            "orderable": false,
