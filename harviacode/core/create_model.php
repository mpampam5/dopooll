...
$string .="\n\n class " . $m . " extends CI_Model{
  ...
  $string .="\n\n    // datatables
      function json() {
          ...
          '<a href=\"'.site_url($load_view\"$c_url/detail/$1\").'\" id=\"detail\" class=\"btn btn-sm btn-primary\">detail</a>
           <a href=\"'.site_url($load_view\"$c_url/edit/$1\").'\" id=\"edit\" class=\"btn btn-sm btn-warning\">edit</a>
           <a href=\"'.site_url($load_view\"$c_url/hapus/$1\").'\" id=\"hapus\" class=\"btn btn-sm btn-danger\">hapus</a>',
           '$pk');
